...
<a class="btn btn-primary b-add" href="<?php echo e("add"); ?>" role="button">Aggiungi Socio</a>
<a class="btn btn-primary b-add" href="<?php echo e("pdfBollettini"); ?>" role="button">Prova bollettini</a>
<hr>
<table class="tab1">
  <tr class="head">
    <td>ID</td>
...
<?php /**PATH /home/rino/LARAVEL/anag_dir/resources/views/anagrafica/AnagraficaList.blade.php ENDPATH**/ ?>